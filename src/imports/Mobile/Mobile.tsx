import svgPaths from "./svg-sd8p133d9v";
...
function Frame1() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute content-stretch flex flex-col gap-[15px] items-start leading-[normal] left-[calc(50%+4.5px)] not-italic text-center text-white top-[calc(50%-734.5px)] w-[411px]">
...
function Frame3() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[62px] items-start left-[17px] top-[678px] w-[378px]">
      <div className="font-['Metropolis:Regular',sans-serif] leading-[0] min-w-full not-italic relative shrink-0 text-[0px] text-white w-[min-content] whitespace-pre-wrap">
...
function Frame14() {
  return (
    <div className="content-stretch flex flex-col items-center justify-end relative shrink-0 w-[381px]">
      <p className="font-['Metropolis:Medium_Italic',sans-serif] leading-[normal] not-italic relative shrink-0 text-[35px] text-white w-full">Sequoias não crescem em qualquer solo.</p>
    </div>
  );
}
...
function Frame5() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] h-[90px] items-start relative shrink-0 w-[284px]">
      <p className="font-['Metropolis:Semi_Bold_Italic',sans-serif] relative shrink-0 text-[24px] w-[248px]">Posicionamento. Raiz que ancora.</p>
      <p className="font-['Rounded_Elegance:Regular',sans-serif] relative shrink-0 text-[20px] w-[284px]">Clareza sobre quem você atende e por que te escolhem.</p>
    </div>
  );
}
...
function Frame9() {
  return (
    <div className="content-stretch flex gap-[37px] items-center relative shrink-0 w-[360px]">
      <p className="font-['Rounded_Elegance:Regular',sans-serif] relative shrink-0 text-[96px] w-[13px]">1</p>
      <Frame5 />
    </div>
  );
}
...
function Frame6() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] h-[90px] items-start relative shrink-0 w-[284px]">
      <p className="font-['Metropolis:Semi_Bold_Italic',sans-serif] relative shrink-0 text-[24px] w-[248px]">Oferta. Raiz que alimenta.</p>
      <p className="font-['Rounded_Elegance:Regular',sans-serif] relative shrink-0 text-[20px] w-[284px]">O que você vende precisa ser irresistível antes de ser anunciado.</p>
    </div>
  );
}
...
function Frame10() {
  return (
    <div className="content-stretch flex gap-[22px] items-center relative shrink-0 w-[280px]">
      <p className="font-['Rounded_Elegance:Regular',sans-serif] relative shrink-0 text-[96px] w-[27px]">2</p>
      <Frame6 />
    </div>
  );
}
...
function Frame7() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] h-[90px] items-start relative shrink-0 w-[284px]">
      <p className="font-['Metropolis:Semi_Bold_Italic',sans-serif] relative shrink-0 text-[24px] w-[248px]">Processos. Raiz que sustenta.</p>
      <p className="font-['Rounded_Elegance:Regular',sans-serif] relative shrink-0 text-[20px] w-[284px]">Sem processo, o crescimento depende de você. Com processo, ele independe.</p>
    </div>
  );
}
...
function Frame11() {
  return (
    <div className="content-stretch flex gap-[22px] items-center relative shrink-0 w-[280px]">
      <p className="font-['Rounded_Elegance:Regular',sans-serif] relative shrink-0 text-[96px] w-[27px]">3</p>
      <Frame7 />
    </div>
  );
}
...
function Frame8() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] h-[90px] items-start relative shrink-0 w-[284px]">
      <p className="font-['Metropolis:Semi_Bold_Italic',sans-serif] relative shrink-0 text-[24px] w-[248px]">Direção. Raiz que orienta.</p>
      <p className="font-['Rounded_Elegance:Regular',sans-serif] relative shrink-0 text-[20px] w-[284px]">Onde você quer chegar define o que você faz hoje.</p>
    </div>
  );
}
...
function Frame12() {
  return (
    <div className="content-stretch flex gap-[21px] items-center relative shrink-0 w-[280px]">
      <p className="font-['Rounded_Elegance:Regular',sans-serif] relative shrink-0 text-[96px] w-[28px]">4</p>
      <Frame8 />
    </div>
  );
}
...
function Frame13() {
  return (
    <div className="content-stretch flex flex-col gap-[34px] items-start leading-[1.1] not-italic relative shrink-0 text-white w-full">
      <Frame9 />
      <Frame10 />
      <Frame11 />
      <Frame12 />
...
function Frame17() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[298px] h-[1304px] items-end left-[24px] top-[1092px] w-[378px]">
      <Frame14 />
      <Frame13 />
      <p className="font-['Metropolis:Medium_Italic',sans-serif] leading-[normal] min-w-full not-italic relative shrink-0 text-[31px] text-white w-[min-content]">
        Solo bem preparado.
        <br aria-hidden="true" />
...
function Sessao1() {
  return (
    <div className="h-[2462px] overflow-clip relative shrink-0 w-[402px]" data-name="Sessão 1/2">
      ...
      <Frame1 />
      <Frame3 />
      <div className="-translate-x-1/2 absolute bottom-[95.74%] left-[calc(50%-88px)] top-[3.01%] w-[178px]" data-name="Vector">
        <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 178 31">
          <g id="Vector">
            <path d={svgPaths.p16d278f0} fill="var(--fill-0, white)" />
            <path d={svgPaths.p1177c780} fill="var(--fill-0, white)" />
            <path d={svgPaths.p1eb9ae00} fill="var(--fill-0, white)" />
            <path d={svgPaths.p25d02e00} fill="var(--fill-0, white)" />
            <path d={svgPaths.p1fadb7f2} fill="var(--fill-0, white)" />
            <path d={svgPaths.p32e58700} fill="var(--fill-0, white)" />
            <path d={svgPaths.p3645f680} fill="var(--fill-0, white)" />
            <path d={svgPaths.p2daa2b00} fill="var(--fill-0, white)" />
            <path d={svgPaths.p2b831e00} fill="var(--fill-0, white)" />
          </g>
        </svg>
      </div>
      <div className="absolute aspect-[27/18] left-[81.59%] right-[6.22%] top-[74px]" data-name="Vector">
        <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 49 33">
          <path d={svgPaths.p28492e00} fill="var(--fill-0, white)" id="Vector" />
        </svg>
      </div>
      <Frame17 />
    </div>
...
function Sessao() {
  return (
    <div className="content-stretch flex flex-col h-[1427px] items-center justify-end overflow-clip relative shrink-0 w-full" data-name="sessao 2">
...
function DepoimentoVideos() {
  return (
    <div className="bg-black h-[134px] relative shrink-0 w-full" data-name="Depoimento videos">
      <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[44px] items-center justify-center pl-[80px] pr-[83px] py-[35px] relative size-full">
...
function DepoimentoVideos1() {
  return (
    <div className="h-[841px] overflow-clip relative shrink-0 w-full" data-name="Depoimento videos">
      ...
      <Frame4 />
      <div className="absolute flex items-center justify-center left-[10px] size-[76px] top-[382px]" style={{ "--transform-inner-width": "285", "--transform-inner-height": "21" } as React.CSSProperties}>
        <div className="-rotate-90 flex-none">
          <PhArrowUpThin />
        </div>
      </div>
      <div className="-translate-x-1/2 absolute flex items-center justify-center left-[calc(50%+153px)] size-[76px] top-[382px]" style={{ "--transform-inner-width": "285", "--transform-inner-height": "21" } as React.CSSProperties}>
  ...
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
      <div className="col-1 h-[647px] ml-0 mt-0 relative row-1 w-[1463px]" data-name="fundo2">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[312.66%] left-[-28.21%] max-w-none top-[-112.85%] w-[156.41%]" src={imgDepoimentoVideos} />
        </div>
      </div>
