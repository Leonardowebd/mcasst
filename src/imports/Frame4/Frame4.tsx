import svgPaths from "./svg-31xjefzpmt";
...
function Group() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
      <div className="col-1 h-[1273px] ml-0 mt-[133px] relative row-1 w-[1440px]" data-name="fundo2">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[156.49%] left-[-28.21%] max-w-none top-[-56.48%] w-[156.41%]" src={imgFundo2} />
        </div>
      </div>
      <div className="col-1 h-[1406px] ml-[310px] mt-0 relative row-1 w-[826px]" data-name="arvore1">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[144.87%] left-[-78.55%] max-w-none top-[-43.59%] w-[279.36%]" src={imgArvore1} />
        </div>
      </div>
      <div className="col-1 h-[173px] ml-[555px] mt-[769px] relative row-1 w-[336px]" data-name="Vector">
